    ...
    <dialog id="editar-maestro" class="px-6 py-4 min-w-[335px] rounded-md">
      ...
      <form action="#" method="POST" class="text-sm mt-6 flex flex-col gap-4">
        <div>
          ...
          <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="email" name="alumno-email" id="alumno-email" placeholder="harold@harold.com">
        </div>
        <div>
          <label for="alumno-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre(s)</label>
          <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="text" name="alumno-name" id="alumno-name" placeholder="Harold">
        </div>
        <div>
          <label for="alumno-surname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Apellido(s)</label>
          <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="text" name="alumno-surname" id="alumno-surname" placeholder="Carazas">
        </div>
        <div>
          <label for="alumno-contact" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Número de teléfono</label>
          <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="text" name="alumno-contact" id="alumno-contact" placeholder="+51 924126535">
        </div>
    ...
    <dialog id="nuevo-maestro" class="px-6 py-4 min-w-[335px] rounded-md">
      ...
      <form action="#" method="POST" class="text-sm mt-6 flex flex-col gap-4">
        <div>
          ...
          <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="email" name="nuevo-alumno-email" id="nuevo-alumno-email" placeholder="alumno@alumno.com">
        </div>
        <div>
          <label for="nuevo-alumno-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre(s)</label>
          <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="text" name="nuevo-alumno-name" id="nuevo-alumno-name" placeholder="Harold">
        </div>
        <div>
          <label for="nuevo-alumno-surname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Apellido(s)</label>
          <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="text" name="nuevo-alumno-surname" id="nuevo-alumno-surname" placeholder="Carazas">
        </div>
        <div>
          ...
          <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="text" name="nuevo-alumno-contact" id="nuevo-alumno-contact" placeholder="+51 924126535">
        </div>
        <div class="buttons ml-auto">
