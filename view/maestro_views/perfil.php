...
<body class="h-[100vh]">
  <div class="text-2xl flex h-full">
    <aside id="toggle-menu" class="menu w-[235px] min-w-[235px] min-h-[100vh] text-sm bg-[#3f454c] text-neutral-300">
      ...
      <div class="p-4">
        <p class="pb-4 pl-6">MENU MAESTRO</p>
        <nav>
          <ul>
            <li>
      ...
      <section class="bg-[#F5F6FA] ">
        ...
        <div class="content text-xs mx-2 mb-3 py-2 px-2 overflow-x-scroll md:text-sm md:px-2 md:py-4 bg-white rounded lg:text-base lg:mx-6">
          ...
          <form action="#" method="POST" class="text-sm mt-6 flex flex-col gap-4">
            <div>
              <label for="editar-maestro-email" class="block font-medium text-sm mb-2 text-gray-900">Correo electrónico</label>
              <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="email" name="editar-maestro-email" id="editar-maestro-email" placeholder="admin@admin.com">
            </div>
            <div>
              <label for="editar-maestro-pass" class="block font-medium text-sm mb-2 text-gray-900">Contraseña nueva</label>
              <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="password" name="editar-maestro-pass" id="editar-maestro-pass" placeholder="********">
            </div>
            <div>
              <label for="repetir-maestro-pass" class="block font-medium text-sm mb-2 text-gray-900">Contraseña de nuevo</label>
              <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="password" name="repetir-maestro-pass" id="repetir-maestro-pass" placeholder="********">
            </div>
            <div>
              <label for="editar-maestro-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre(s)</label>
              <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="text" name="editar-maestro-name" id="editar-maestro-name" placeholder="Administrador">
            </div>
            <div>
              <label for="editar-maestro-surname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Apellido(s)</label>
              <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="text" name="editar-maestro-surname" id="editar-maestro-surname" placeholder="Administrador">
            </div>
            <div>
              <label for="editar-maestro-contact" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Número de teléfono</label>
              <input class="px-2 py-1 w-full bg-gray-50 border-gray-300 border-2 rounded-lg text-gray-500 text-xs lg:text-sm" type="text" name="editar-maestro-contact" id="editar-maestro-contact" placeholder="+51 924126535">
            </div>
